...
namespace Needle.Deeplink.Component
{
    public class EditorDeepLink : MonoBehaviour
    {
#if UNITY_EDITOR
        [DeepLink]
        ...
        [DeepLink(RegexFilter = @"com.unity3d.kharma:select-object\/(.*)")]
        private static bool CallMethodOnGameObject(string data)
        {
            var objects = GameObject.FindObjectsOfType<EditorDeepLink>();
